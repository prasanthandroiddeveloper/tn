...
class ImagePicker {
    ...
    private static final String TEMP_IMAGE_NAME = "TripImage";
    ...
    static Intent getPickImageIntent(Context context) {
        ...
        if (intentList.size() > 0) {
            chooserIntent = Intent.createChooser(intentList.remove(intentList.size() - 1),"Choose Image");
    ...
    static Bitmap getImageFromResult(Context context, int resultCode, Intent imageReturnedIntent) {
        Bitmap bm = null;
    ...
    private static Bitmap decodeBitmap(Context context, Uri theUri, int sampleSize) {
        ...
        return BitmapFactory.decodeFileDescriptor(fileDescriptor != null ? fileDescriptor.getFileDescriptor() : null, null, options);
    }
