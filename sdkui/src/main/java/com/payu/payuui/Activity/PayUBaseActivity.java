...
public class PayUBaseActivity extends FragmentActivity implements PaymentRelatedDetailsListener, ValueAddedServiceApiListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        (payNowButton = findViewById(R.id.button_pay_now)).setOnClickListener(this);
...
//                 close the progress bar
            ...
            public void onPageSelected(int position) {
                ...
                switch (paymentOptionsList.get(position)) {
                    case SdkUIConstants.SAVED_CARDS:
                        ViewPager myViewPager = findViewById(R.id.pager_saved_card);
    ...
    private void makePaymentByCreditCard() {
        CheckBox saveCardCheckBox = findViewById(R.id.check_box_save_card);
        CheckBox enableOneClickPaymentCheckBox = findViewById(R.id.check_box_enable_oneclick_payment);
    ...
    private void makePaymentByStoredCard() {
        ...
        ViewPager viewPager = findViewById(R.id.pager_saved_card);
    ...
    private void makePaymentByUPI() {
        ...
        EditText etVirtualAddress = findViewById(R.id.et_virtual_address);
