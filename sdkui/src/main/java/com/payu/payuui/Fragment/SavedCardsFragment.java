...
public class SavedCardsFragment extends Fragment implements View.OnClickListener, DeleteCardApiListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPager = mView.findViewById(R.id.pager_saved_card);
        mPager.setAdapter(mAdapter);
        mPager.setClipToPadding(false);
        (deleteButton = mView.findViewById(R.id.button_delete)).setOnClickListener(this);
        titleText = mView.findViewById(R.id.edit_text_title);
