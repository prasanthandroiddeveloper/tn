...
public class NetBankingFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bankDownText = view.findViewById(R.id.text_view_bank_down_error);

        (axisImageButton = view.findViewById(R.id.image_button_axis)).setOnClickListener(this);
        (hdfcImageButton = view.findViewById(R.id.image_button_hdfc)).setOnClickListener(this);
        (citiImageButton = view.findViewById(R.id.image_button_citi)).setOnClickListener(this);
        (sbiImageButton = view.findViewById(R.id.image_button_sbi)).setOnClickListener(this);
        (iciciImageButton = view.findViewById(R.id.image_button_icici)).setOnClickListener(this);
        ...
        if (netBankingList != null) {
            ...
            spinnerNetbanking = view.findViewById(R.id.spinner);
